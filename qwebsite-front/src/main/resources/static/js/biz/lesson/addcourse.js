    ...
    var Service = {
        _queryDicts: function (){
            Ajax.query("queryDicts",{
                ...
                data:{"entryCodes":"lessonKind,lessonType"},
                callback:function (result) {
                    $("#lessonKind").html(_setSelect(result["lessonKind"],"lessonKind"));
                    $("#lessonType").html(_setSelect(result["lessonType"],"lessonType"));
                    _initSelectEvent();
                }
            })
        }

    ...
    window.Manager = {
        ...
        delAllSelectedVal:function(e){
            ...
            Tool.layer_confirm("确认删除选中的数据?",function () {
                Ajax.submit("delEntry", {
                    url: "/competition_apply/delSelectedBox",
        ...
        exportExcel:function () {
            ...
            Ajax.query("getData",{
                url:"/competition_apply/checkExport?"+p,
                callback:function (result) {
                    if(result=="success"){
                        window.top.location.href = path +  "/competition_apply/export?" + p;
                    }else{

    ...
    window.Manager = {
        ...
        changeReadFlag:function(id,readFlag,e){
            ...
            var index = Tool.layer_confirm("确认改变此条信息的阅读状态?",function () {
                ...
                Ajax.submit("updateEntry", {
                    url: "/activity_square_apply/edit",
        ...
        delAllSelectedVal:function(e){
            ...
            Tool.layer_confirm("确认删除选中的数据?",function () {
                Ajax.submit("delEntry", {
                    url: "/activity_square_apply/delSelectedBox",
        ...
        exportExcel:function () {
            ...
            Ajax.query("getData",{
                url:"/activity_square_apply/checkExport?realName="+realName+"&sex="+sex+"&readFlag="+readFlag,
                callback:function (result) {
                    if(result=="success"){
                        window.top.location.href = path + "/activity_square_apply/export?realName="+realName+"&sex="+sex+"&readFlag="+readFlag;
                    }else{

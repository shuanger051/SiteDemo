var TrainApplyList = function (){
    ...
    table.init({
        tId:"table",
        url:"/train_square_apply/queryList",
        page_size:10
    });
    ...
    window.Manager = {
        ...
        changeReadFlag:function(id,readFlag,e){
            ...
            var index = Tool.layer_confirm("确认改变此条信息的阅读状态?",function () {
                ...
                Ajax.submit("updateSquareEntry", {
                    url: "/train_square_apply/edit",
        ...
        delAllSelectedVal:function(e){
            ...
            Tool.layer_confirm("确认删除选中的数据?",function () {
                Ajax.submit("delEntry", {
                    url: "/train_square_apply/delSelectedBox",
        ...
        setAllStatusReaded:function (e) {
            ...
            var index = Tool.layer_confirm("确认批量改变阅读状态?",function () {
                ...
                Ajax.submit("updateEntryReadFlag", {
                    url: "/train_square_apply/updeateReadFlagList",

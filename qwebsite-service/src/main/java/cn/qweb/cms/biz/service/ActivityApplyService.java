...
public interface ActivityApplyService {
     ...
     * @return  分页对象
     */
    Pagination<ActivityApplyDTO> list(ActivityApplyQUERY bean);
     ...
     * @return  分页对象
     */
    List<ActivityApplyDTO> queryList(ActivityApplyQUERY bean);
     ...
     * @return 主键
     */
    Long doSave(ActivityApplySaveBO bean);
     ...
     * @return 更新的记录条数
     */
    Integer doUpdate(ActivityApplyUpdateBO bean);
     ...
     * @return  删除的记录条数
     */
    Integer doRemove(ActivityApplyRemoveBO bean);
     ...
     * @return 数据总条数
     */
    Integer checkExport(ActivityApplyQUERY activityApplyQUERY);

...
public class IndexFloatingDTO implements Serializable{
    ...
    /**
     * @Fields floating_position:浮窗显示位置
     */
    private String floatingPosition;
    /**
     * @Fields floatingPositionName :浮窗显示位置 字典翻译
     */
    private String floatingPositionName;
    /**
    ...
    public void setFloatingPosition(String floatingPosition) {
        ...
        this.floatingPositionName = DictManager.getItem("floatingPosition",floatingPosition);
    }
    public String getFloatingPositionName() {
        return floatingPositionName;
    }
    public void setFloatingPositionName(String floatingPositionName) {
        this.floatingPositionName = floatingPositionName;
    }
